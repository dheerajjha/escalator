...
This directory contains the Fastlane configuration for **escalator**.
...
✅ **Certificate repository:** https://github.com/dheerajjha/ios-certificates  
...
- Check that provisioning profiles match your bundle ID: com.example.escalator
